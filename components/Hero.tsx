...
const Hero = () => {
  ...
  return (
    <section
      id="about-me"
          className={`
           w-full min-h-screen flex items-center px-4 sm:px-6 md:px-8
            ${isMobile ? "mt-10" : ""}
          `}
    >
      ...
      <div className="w-full flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-0 lg:ml-10 lg:px-10 lg:px-32">
        ...
        <div className="flex flex-col text-white max-w-xl gap-3 text-center lg:text-left">
          <p className="font-tech text-[16px] sm:text-2xl md:text-3xl">Hi I&apos;m,</p>
          ...
          <h2 className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-1 sm:gap-4 mt-2 sm:mt-6">
            <span className="font-body text-xl sm:text-3xl md:text-4xl ">AI Software Engineer</span>
...
<div className="mt-6 sm:mt-8">
  <p className="font-tech text-gray-400 text-[13px] sm:text-lg md:text-xl lg:text-2xl max-w-3xl text-center lg:text-left mx-auto lg:mx-0">
