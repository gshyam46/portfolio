...
//   return (
//     <section ref={containerRef} className="relative w-full mt-10 pt-10 z-30">
//       {/* Heading */}
//       <div className="relative z-10 flex mt-15 pt-3 justify-center mb-16">
//         <GlassHeading
...
//         </div>
//       </div>
//       <div className="absolute top-[695px] left-0 w-full  z-[0] overflow-hidden">
//      <video
//                    autoPlay
//                    muted
//                    loop
